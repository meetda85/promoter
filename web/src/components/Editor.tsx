...
/**
 * Editor del guion. Todo lo que se marque aquí (color, resaltado, sombreado,
 * tamaño de un párrafo suelto, notas) viaja dentro del HTML del guion y se
 * pinta igual en el prompter.
 */
export function Editor({ id }: { id: string }) {
  ...
  }, [dirty, title, editor, script, saveScript])
